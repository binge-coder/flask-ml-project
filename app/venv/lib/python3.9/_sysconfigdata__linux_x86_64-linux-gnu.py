...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/home/xen/x/c/uni/dma/flask/app/venv/bin',
 'BINLIBDEST': '/home/xen/x/c/uni/dma/flask/app/venv/lib/python3.9',
 'BLDLIBRARY': 'libpython3.9.a',
 'BLDSHARED': ''
              'gcc -pthread -B /home/xen/x/c/uni/dma/flask/app/venv/compiler_compat -Wl,--sysroot=/ -shared  '
              ''
              ''
              '-Wl,-rpath,/home/xen/x/c/uni/dma/flask/app/venv/lib '
              '-Wl,-rpath-link,/home/xen/x/c/uni/dma/flask/app/venv/lib '
              '-L/home/xen/x/c/uni/dma/flask/app/venv/lib '
              ''
              ''
              '-Wl,-rpath,/home/xen/x/c/uni/dma/flask/app/venv/lib '
              '-Wl,-rpath-link,/home/xen/x/c/uni/dma/flask/app/venv/lib '
 ...
 'BYTESTR_DEPS': '\\',
 'CC': ''
       'gcc -pthread -B /home/xen/x/c/uni/dma/flask/app/venv/compiler_compat -Wl,--sysroot=/',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG  -O2 -Wall '
           '   -fPIC '
           '  -O2   '
           '-isystem '
           '/home/xen/x/c/uni/dma/flask/app/venv/include '
           ''
           ''
           ''
           '   -fPIC '
 ...
 'CONFIGURE_CPPFLAGS': '-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem '
                       '/home/xen/x/c/uni/dma/flask/app/venv/include '
                       '-I/home/xen/x/c/uni/dma/flask/app/venv/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      '-Wl,-rpath,/home/xen/x/c/uni/dma/flask/app/venv/lib '
                      '-Wl,-rpath-link,/home/xen/x/c/uni/dma/flask/app/venv/lib '
 ...
 'CONFIGURE_LDFLAGS_NODIST': ''
                             ' -g',
 'CONFIG_ARGS': "'--prefix=/home/xen/x/c/uni/dma/flask/app/venv' "
                "'--build=x86_64-conda_cos6-linux-gnu' "
                "'--host=x86_64-conda_cos6-linux-gnu''--enable-ipv6' "
                "'--with-ensurepip=no' "
                "'--with-tzpath=/home/xen/x/c/uni/dma/flask/app/venv/share/zoneinfo:/home/xen/x/c/uni/dma/flask/app/venv/share/tzinfo' "
                "'--with-computed-gotos''--with-system-ffi' "
                "'--enable-loadable-sqlite-extensions' "
                "'--with-tcltk-includes=-I/home/xen/x/c/uni/dma/flask/app/venv/include' "
                "'--with-tcltk-libs=-L/home/xen/x/c/uni/dma/flask/app/venv/lib "
                ...
                '/home/xen/x/c/uni/dma/flask/app/venv/include '
                "-I/home/xen/x/c/uni/dma/flask/app/venv/include' "
                "'CPP=/tmp/build/80754af9/python-split_1605449976777/_build_env/bin/cpp' "
                "'PKG_CONFIG_PATH=/home/xen/x/c/uni/dma/flask/app/venv/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/home/xen/x/c/uni/dma/flask/app/venv/include',
 'CONFINCLUDEPY': '/home/xen/x/c/uni/dma/flask/app/venv/include/python3.9',
 'COREPYTHONPATH': '',
 ...
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             ...
             '/home/xen/x/c/uni/dma/flask/app/venv/include '
             '-I/home/xen/x/c/uni/dma/flask/app/venv/include',
 'CXX': 'g++ -pthread -B /home/xen/x/c/uni/dma/flask/app/venv/compiler_compat -Wl,--sysroot=/',
 'DESTDIRS': '/home/xen/x/c/uni/dma/flask/app/venv '
             '/home/xen/x/c/uni/dma/flask/app/venv/lib '
             '/home/xen/x/c/uni/dma/flask/app/venv/lib/python3.9 '
             '/home/xen/x/c/uni/dma/flask/app/venv/lib/python3.9/lib-dynload',
 'DESTLIB': '/home/xen/x/c/uni/dma/flask/app/venv/lib/python3.9',
 'DESTPATH': '',
 'DESTSHARED': '/home/xen/x/c/uni/dma/flask/app/venv/lib/python3.9/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/home/xen/x/c/uni/dma/flask/app/venv/include '
                   '/home/xen/x/c/uni/dma/flask/app/venv/include '
                   '/home/xen/x/c/uni/dma/flask/app/venv/include/python3.9 '
                   '/home/xen/x/c/uni/dma/flask/app/venv/include/python3.9',
 'INCLUDEDIR': '/home/xen/x/c/uni/dma/flask/app/venv/include',
 'INCLUDEPY': '/home/xen/x/c/uni/dma/flask/app/venv/include/python3.9',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -pthread -B /home/xen/x/c/uni/dma/flask/app/venv/compiler_compat -Wl,--sysroot=/ -shared',
 'LDFLAGS': ''
            ''
            '-Wl,-rpath,/home/xen/x/c/uni/dma/flask/app/venv/lib '
            '-Wl,-rpath-link,/home/xen/x/c/uni/dma/flask/app/venv/lib '
 ...
 'LDVERSION': '3.9',
 'LIBC': '',
 'LIBDEST': '/home/xen/x/c/uni/dma/flask/app/venv/lib/python3.9',
 'LIBDIR': '/home/xen/x/c/uni/dma/flask/app/venv/lib',
 'LIBFFI_INCLUDEDIR': '/home/xen/x/c/uni/dma/flask/app/venv/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/xen/x/c/uni/dma/flask/app/venv/lib/pkgconfig',
 'LIBPL': '/home/xen/x/c/uni/dma/flask/app/venv/lib/python3.9/config-3.9-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/home/xen/x/c/uni/dma/flask/app/venv/lib/python3.9',
 ...
 'MANDIR': '/home/xen/x/c/uni/dma/flask/app/venv/share/man',
 'MKDIR_P': '/bin/mkdir -p',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/home/xen/x/c/uni/dma/flask/app/venv/include',
 'OPENSSL_LDFLAGS': '-L/home/xen/x/c/uni/dma/flask/app/venv/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/home/xen/x/c/uni/dma/flask/app/venv/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TCLTK_INCLUDES': '-I/home/xen/x/c/uni/dma/flask/app/venv/include',
 'TCLTK_LIBS': '-L/home/xen/x/c/uni/dma/flask/app/venv/lib '
               '-ltcl8.6 -ltk8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': './python',
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/home/xen/x/c/uni/dma/flask/app/venv/share/zoneinfo:/home/xen/x/c/uni/dma/flask/app/venv/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 'UPDATE_FILE': 'python3 '
 ...
 'datarootdir': '/home/xen/x/c/uni/dma/flask/app/venv/share',
